...
str4: .asciiz " , "
str5: .asciiz "]\n"
str6: .asciiz "\nMang sau khi thuc hien mergeShort:\n"
array: .word 0:100
str7: .asciiz "->merge\n"
str8: .asciiz "-|->"
str9: .asciiz "**"
...
for:			# chay vong lap nhap vao mang so nguyen 50 phan tu
	...
	addi $t6 , $0 , 0
	jal mergeSort    #goi ham mergeShort
	la $a2, str6
...
# MergeSort MIPS
mergeSort:
	addi $sp, $sp, -20  # dieu chinh con tro cua ngan xep
	sw $t6, 16($sp)
	...
	add $a1, $a0,$t1 # dua dia chi giua thanh dia chi cuoi khi goi lai ham mergeShort
	...
	lw $a1, 12($sp)
	jal printshow
	jal mergeSort # goi de quy mergeShort voi nua dau cua mang
	...
	jal printshow
	jal mergeSort # goi de quy mergeShort voi nua mang cuoi
...
mSEnd:
	...
	addi $sp, $sp,20 # giai phong con tro
	jr $ra		# return      ket thu ham mergeshort
...
## $a0 dia chi dau 
## $a1 dia chi cuoi
## in day chay tu dia chi dau den dia chi cuoi
printshow:
	add $s0, $a0, $0
	add $s1, $a0, $0
	la $a0 , str3
